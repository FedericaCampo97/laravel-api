...
<body>
    <div id="app">
        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-2 shadow">
            ...
            <input class="form-control form-control-dark" style="width: 70%;" type="text" placeholder="Search" aria-label="Search">
            <div class="navbar-nav">
                <div class="nav-item text-nowrap ms-2">
                    <a class="nav-link me-5" href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        <div class="container-fluid vh-100">
            <div class="row h-100">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-img">
                    @yield('content')
                </main>
            </div>
        </div>
