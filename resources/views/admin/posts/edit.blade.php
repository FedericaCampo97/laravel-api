...
<h1 class="my-5">Edit post: {{$post->title}}</h1>
    ...
    <div class="card-body">
        <form action="{{route('admin.posts.update',$post)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control @error ('title') is-invalid @enderror" placeholder="Enter a title" aria-describedby="helperTitle" value="{{old('title', $post->title)}}">
            ...
            <button class="btn btn-primary" type="submit"> Update your post
